...
//
//        std::memcpy((void *)rShiftAddA, (void *)&RSHIFT_ADD(ChA, 0, 0), 2 * Range::Count * 2); // —начала сохран€ем несбрасываемые настройки
...
//
//        std::memcpy((void *)&RSHIFT_ADD(ChA, 0, 0), (void *)rShiftAddA, 2 * Range::Count * 2);  // » восстанавливаем несбрасываемые настройки
