...
static const Settings defaultSettings =
{
    ...
    // Display
    {
        ...
        20,                         // brightnessGrid
        {
            MAKE_COLOR(0x00, 0x00, 0x00),   // Color::BLACK = 0x00,
            MAKE_COLOR(0xFF, 0xFF, 0xFF),   // Color::WHITE = 0x01,
            MAKE_COLOR(0x80, 0x80, 0x80),   // Color::GRID = 0x02,
            MAKE_COLOR(0x01, 0xCA, 0xFF),   // Color::DATA_A = 0x03,
            MAKE_COLOR(0x00, 0xFF, 0x00),   // COLOR_DATA_B = 0x04,
            MAKE_COLOR(0xD5, 0xDA, 0xD5),   // Color::MENU_FIELD = 0x05,
            MAKE_COLOR(0xFF, 0xB2, 0x00),   // COLOR_MENU_TITLE = 0x06,
            MAKE_COLOR(0x7B, 0x59, 0x00),   // Color::MENU_TITLE_DARK = 0x07,
            MAKE_COLOR(0xFF, 0xFF, 0x00),   // Color::MENU_TITLE_BRIGHT = 0x08,
            MAKE_COLOR(0x69, 0x89, 0x00),   // COLOR_MENU_ITEM = 0x09,
            MAKE_COLOR(0x6B, 0x45, 0x00),   // Color::MENU_ITEM_DARK = 0x0a,
            MAKE_COLOR(0xFF, 0xCE, 0x00),   // Color::MENU_ITEM_BRIGHT = 0x0b,
            MAKE_COLOR(0x00, 0x00, 0x00),   // Color::MENU_SHADOW = 0x0c,
            MAKE_COLOR(0x00, 0x00, 0x00),   // COLOR_EMPTY = 0x0d,
            MAKE_COLOR(0x08, 0xA2, 0xCE),   // COLOR_EMPTY_A = 0x0e,
            MAKE_COLOR(0x00, 0xCE, 0x00)    // COLOR_EMPTY_B = 0x0f,
        },
