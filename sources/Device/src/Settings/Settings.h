...
#define BALANCE_ADC_A                       (BALANCE_ADC(Channel::A_))
#define BALANCE_ADC_B                       (BALANCE_ADC(Channel::B_))
...
#define DEBUG_STRETCH_ADC_A                 (DEBUG_STRETCH_ADC(Channel::A_))
#define DEBUG_STRETCH_ADC_B                 (DEBUG_STRETCH_ADC(Channel::B_))
