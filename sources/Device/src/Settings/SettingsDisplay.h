...
#define LAST_AFFECTED_CHANNEL_IS_A  (LAST_AFFECTED_CHANNEL == Channel::A_)       // \c true, если последний канал, которым управляли - 1.
#define LAST_AFFECTED_CHANNEL_IS_B  (LAST_AFFECTED_CHANNEL == Channel::B_)       // \c true, если последний канал, которым управляли - 2.
