...
void Choice::DrawOpened(int x, int y) const
{
    ...
    DrawVolumeButton(x, y + Item::OPENED_HEIGHT_TITLE, Item::OPENED_WIDTH - 1, height - Item::OPENED_HEIGHT_TITLE, 1, Color::BLACK, Color::MenuTitleBrighter(), Color::MENU_TITLE_DARK, false);
    ...
    for(int i = 0; i < NumSubItems(); i++)
    {
        ...
        if(pressed)
        {
            DrawVolumeButton(x + 1, yItem, Item::OPENED_WIDTH - 2 , Item::OPENED_HEIGHT - 2, 2, Color::MENU_FIELD, Color::MenuTitleBrighter(), Color::MENU_TITLE_DARK, pressed);
        }
...
void TimeItem::DrawOpened(int x, int y) const
{
    ...
    std::strcpy(strI[iDAY], Int2String(*own->day, false, 2, buffer)); //-V2513
    std::strcpy(strI[iMONTH], Int2String(*own->month, false, 2, buffer)); //-V2513
    std::strcpy(strI[iYEAR], Int2String(*own->year, false, 2, buffer)); //-V2513
    std::strcpy(strI[iHOURS], Int2String(*own->hours, false, 2, buffer)); //-V2513
    std::strcpy(strI[iMIN], Int2String(*own->minutes, false, 2, buffer)); //-V2513
    std::strcpy(strI[iSEC], Int2String(*own->seconds, false, 2, buffer)); //-V2513
...
static void GovernorIpCommon_DrawOpened(const Item *item, int x, int y, int dWidth)
{
    ...
    item->DrawVolumeButton(x, y + Item::OPENED_HEIGHT_TITLE, Item::OPENED_WIDTH - 1 + dWidth, height - Item::OPENED_HEIGHT_TITLE, 1, Color::BLACK, Color::MenuTitleBrighter(), Color::MENU_TITLE_DARK, false);
}
...
void Button::Draw(int x, int y, bool) const
{
    ...
    DrawVolumeButton(x + 4, y + 5, Item::WIDTH - 8, Item::HEIGHT - 8, 3, Color::MENU_ITEM, Color::MENU_ITEM_BRIGHT, Color::MENU_ITEM_DARK, pressed);
...
void Page::Draw(int x, int y, bool) const
{
    ...
    DrawVolumeButton(x + 1, y + 2, Item::WIDTH - 2, Item::HEIGHT - 2, 2, Color::MENU_ITEM, Color::MENU_ITEM_BRIGHT, Color::MENU_ITEM_DARK, isPressed);
...
void Page::DrawTitle(int yTop) //-V2506
{
    ...
    {
        DrawVolumeButton(x + 1, yTop + 1, Item::TITLE_WIDTH - 1, Item::TITLE_HEIGHT - 1, 3, Color::MENU_TITLE, Color::MenuTitleBrighter(), Color::MENU_TITLE_DARK, false);
    }
