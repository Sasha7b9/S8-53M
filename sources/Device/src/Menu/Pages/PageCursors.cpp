...
static void SetShiftCursPosU(const Channel &ch, int numCur, float delta);  // Изменить значение позиции курсора
                                                                           // напряжения на delta точек
static void SetShiftCursPosT(const Channel &ch, int numCurs, float delta); // Изменить значение позиции курсора времени
                                                                           // на delta точек
