...
static const ButtonBase name = { TypeItem::Button, 0, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},   \
    funcPress, funcDraw };


#define DEF_TIME(name, titleRU, titleEN, hintRU, hintEN, keeper, funcActive, cur, h, mi, s, mo, d, y)                           \
static const TimeBase name = { TypeItem::Time, 0, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},       \
    &cur, &h, &mi, &s, &mo, &d, &y };


#define DEF_GOVERNOR(name, titleRU, titleEN, hintRU, hintEN, cell, min, max, keeper, funcActive, funcChanged, funcBeforeDraw)   \
static const GovernorBase name = {TypeItem::Governor, 0, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},\
...
static const IPaddressBase name = {TypeItem::IP, 0, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},     \
...
static const MACaddressBase name = {TypeItem::MAC, 0, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},           \
    &mac0, &mac1, &mac2, &mac3, &mac4, &mac5, funcOfChanged};


#define DEF_GOVERNOR_COLOR(name, titleRU, titleEN, hintRU, hintEN, colorType, keeper)                                           \
static const GovernorColorBase name = {TypeItem::GovernorColor, 0, false, Page::ENoPage, &keeper, FuncActive,                          \
...
ChoiceParameterBase name = {Item_ChoiceParameter, 0, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN} ,       \
...
static const SButtonBase name = { TypeItem::SmallButton, 0, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},         \
    funcPress, funcDraw, 0, 0};

#define DEF_SMALL_BUTTON_EXIT(name, keeper, funcActive, funcPress, funcDraw)                                                                \
static const SButtonBase name = { TypeItem::SmallButton, 0, false, Page::ENoPage, &keeper, funcActive, {"Выход", "Exit",                           \
...
static const ChoiceBase name = {TypeItem::Choice, 2, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN},                        \
...
static const ChoiceBase name = {TypeItem::Choice, 3, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
...
static const ChoiceBase name = {TypeItem::Choice, 4, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
    hints##name, funcChanged, funcDraw};
...
static pString hints##name[] = {nameRu1, nameEn1, nameRu2, nameEn2, nameRu3, nameEn3, nameRu4, nameEn4,                                             \
    nameRu5, nameEn5};                                                                                                                              \
static const ChoiceBase name = {TypeItem::Choice, 5, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {TypeItem::Choice, 6, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {TypeItem::Choice, 7, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {TypeItem::Choice, 8, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,         \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {TypeItem::ChoiceReg, 9, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,      \
    hints##name, funcChanged, funcDraw};
...
static const ChoiceBase name = {TypeItem::ChoiceReg, 10, false, Page::ENoPage, &keeper, funcActive, {titleRU, titleEN, hintRU, hintEN}, (int8 *)&cell,     \
    hints##name, funcChanged, funcDraw};
