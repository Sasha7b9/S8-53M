...
#define STEP_RSHIFT static_cast<int16>(((RShift::MAX - RShift::MIN) / 24) / Grid::Delta())   // На столько единиц нужно
...
#define TrigLevZero RShift::ZERO // Нулевое значение уровня синхронизации, засылаемое в прибор. Маркер синхронизации при
