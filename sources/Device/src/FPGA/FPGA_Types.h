...
#define FL_FIRST_BYTE                   6   // 6 - признак последней записи - определяет, какой байт ставить первым
...
struct Value
{
    ...
    static uint8 FromVoltage(const Voltage &voltage, Range::E range, int16 rshift);
};
